      ...
      <div className="mb-6">
        <div className="border-b border-gray-200">
          <nav className="-mb-px flex space-x-2">
            <button
              className={`py-2 px-4 text-center border-b-2 font-medium ${activeTab === "orders"
            ...
            {isAdmin && (
              <button
                className={`py-2 px-4 text-center border-b-2 font-medium ${activeTab === "estimates"
                  ? "border-blue-500 text-blue-600"
                  : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"
                  }`}
                        ...
                        <tr key={order._id} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${getStatusBadgeColor(order.status)}`}>
                              {order.estimate_id ? order.estimate_id : "No Estimate"}
                            </span>
                          </td>
